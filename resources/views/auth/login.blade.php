            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-muted text-center font-size-18" style="padding-top: 30px;"><b> Giriş Yap </b></h4>
                        ...
                        <div class="p-3">
                            ...
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('login') }}">
                             @csrf
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input id="password" name="password" class="form-control"  required="" placeholder="Şifre">
                                ...
                                <div class="form-group mb-3 text-center row mt-3 pt-1">
                                    <div class="col-12">
                                        <button class="btn btn-info w-100 waves-effect waves-light" type="submit" style="background-color: #01103fff;">Giriş</button>
                                    </div>
                                </div>
